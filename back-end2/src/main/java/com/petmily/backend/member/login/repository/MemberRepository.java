...
public interface MemberRepository extends JpaRepository<Member, Long> {
 ...
 // 회원가입
     ...
     void register(@Param("memberId") String memberId, @Param("memberPw") String memberPw, @Param("memberNickname") String memberNickname,
                       @Param("memberEmail") String memberEmail, @Param("memberName") String memberName, @Param("memberGender") String memberGender,
